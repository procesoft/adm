...
class C_test extends CI_Controller {
    ...
    public function create_pdf_tras() {
        try {
            $count = 0;
            $hoy=getdate();
            extract($_GET);
            ...
            $query = $this->db->query('CALL sp_get_detalle_registro(?,?)', array($registro,$cementerio));
...
EOD;
    ...
    public function create_pdf_ex() {
        try {
            ...
            $query = $this->db->query('CALL sp_get_detalle_exhumacion(?,?)', array($registro,$cementerio));
            if (!$query) {
                throw new Exception('Error en query');
                return false;
            }
            ...
            if ($query->num_rows() == 0) {
                echo "No existen datos";
                $bandera_continuar_ex = false;
            } else {
                $info = $query->result_array();
                $bandera_continuar_ex = true;
            }
        } catch (Exception $ex) {
            echo "Hubo un error al momento de intentar imprimir el pdf, intentalo más tarde";
            $bandera_continuar_ex = false;
        ...
        if ($bandera_continuar_ex == true) {
            ...
            foreach ($info as $datos) {
                    ...
                    $raw_html .='<table><tr>'
                            ...
                            . '<br><tr>'
                            . '<td style="width:20%;"><h3>Nombre del fallecido:</h3></td>'
                            . '<td style="width:30%;"></td>'
                            . '<td style="width:40%; text-align: right;"><b>Registro: </b>' . $datos['id_registro'] . '</td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center; width:50%;">  ' . $datos['nombre'] . '</td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="width:18%;"><h3>Partida de pago:</h3> </td>'
                            . '<td style="text-align: center;width:20%;"> </td>'
                            . '<td style="width:25%;"><h3>Fecha de exhumación:</h3> </td>'
                            . '<td style="text-align: center; width:10%;">  </td>'
                            . '<td style="width:25%;"><h3>Fecha de inhumación:</h3> </td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center; width:25%;">  ' . $datos['ppago'] . '</td>'
                            . '<td style="width:13%;"></td>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:25%;">  ' . $datos['fechaex'] . '</td>'
                            . '<td style="width:11%;"></td>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:25%;">  ' . $datos['fechain'] . '</td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="width:18%;"><h3>Sección:</h3> </td>'
                            . '<td style="text-align: center;width:10%;"> </td>'
                            ...
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:18%;">  ' . $datos['seccionex'] . '</td>'
                            . '<td style="width:10%;"></td>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:18%;">  ' . $datos['lineaex'] . '</td>'
                            . '<td style="width:10%;"></td>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:18%;">  ' . $datos['fosaex'] . '</td>'
                            . '</tr>'

                            . '<br><tr>'
                            . '<td style="width:18%;"><h3>Tipo de traslado:</h3> </td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center; width:35%;">  ' .($datos['estatus']=="M"?"En el mismo cementerio":($datos['estatus']=="E"?"Externo":($datos['estatus']=="T"?"Traslado":$datos['estatus']))) . '</td>'
                            . '</tr>'

                            . '<br><tr>'
                            . '<td style="width:18%;"><h3>Traslado a:</h3> </td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center; width:100%;">  ' . $datos['externo'] . '</td>'
                            . '</tr>'
                            ...
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:18%;">  ' . $datos['seccionin'] . '</td>'
                            . '<td style="width:10%;"></td>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:18%;">  ' . $datos['lineain'] . '</td>'
                            . '<td style="width:10%;"></td>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:18%;">  ' . $datos['fosain'] . '</td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="width:30%;"><h3>Nombre del solicitante:</h3> </td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center; width:100%;">  ' . $datos['nombre_solicitante'] . '</td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="width:20%;"><h3>calle: </h3></td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center; width:100%;">  '. $datos['calle'] . '</td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="width:20%"><h3>Colonia:</h3></td>'
                            . '<br></tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center; width:100%;">  ' . $datos['colonia'] . '</td>'
                            . '<br></tr>'
                            . '<br><tr>'
                            . '<td style="width:18%;"><h3>Estado:</h3> </td>'
                            . '<td style="text-align: center;width:36%;"> </td>'
                            . '<td style="width:18%;"><h3>Municipio:</h3> </td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:40%;">  ' . $datos['nombre_estado'] . '</td>'
                            . '<td style="width:15%;"></td>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:40%;">  ' . $datos['nombre_municipio'] . '</td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="width:18%;"><h3>Teléfono:</h3> </td>'
                            . '</tr>'
                            . '<br><tr>'
                            . '<td style="border-bottom: .5px solid black;float:left;text-align: center;width:40%;">  ' . $datos['telefono'] . '</td>'
                            . '</tr>'
                            . '<br><br><tr>'
